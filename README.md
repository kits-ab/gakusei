...
**Note #1:** The following tools are useful for installing under development: [Redux-devtools](https://github.com/zalmoxisus/redux-devtools-extension), and [React-devtools](https://github.com/facebook/react-devtools)
