      ...
      <Col xs={12} md={8} mdOffset={2}>
        <div>
          ...
          <DisplayQuestion
            ...
            japaneseCharacters showSpeechButton smallerText
          />
          <DisplayQuestion
            primaryText={'私は食べられる。'}
          ...
          <h2 id="gcon_16" style={titleStyle}>~し - Förklaringar <a href="#gcon_16">#</a></h2>
          ...
          <hr />
          <p>Textbok kap. 13</p><hr />
          <h2 id="gcon_17" style={titleStyle}>~そうです - Det ser ut som att... <a href="#gcon_17">#</a></h2>
          ...
          <p>Textbok kap. 13</p><hr />
          <h2 id="gcon_18" style={titleStyle}>そうな~ - Som verkar vara <a href="#gcon_18">#</a></h2>
          ...
          /><hr />
          <p>Textbok kap. 13</p><hr />
          <h2 id="gcon_19" style={titleStyle}>~てみる - Försöka eller prova <a href="#gcon_19">#</a></h2>
          ...
          <p>Textbok kap. 13</p><hr />
          <h2 id="gcon_20" style={titleStyle}>~なら - Men bara <a href="#gcon_20">#</a></h2>
          ...
          <p>Textbok kap. 13</p><hr />
          <h2 id="gcon_21" style={titleStyle}>~に~回 - X gånger per Y <a href="#gcon_21">#</a></h2>
          <p>period Y + に + frekvens X + 回 = X gånger per Y. "3 ggr om dagen." "En gång per månad."</p>
          <p>Textbok kap. 13</p><hr />
          <h2 id="gcon_22" style={titleStyle}>ほしい - Jag vill ha <a href="#gcon_22">#</a></h2>
          ...
          <h2 id="gcon_23" style={titleStyle}>~かもしれません - Det är möjligt att... <a href="#gcon_23">#</a></h2>
          ...
          <p>Textbok kap. 14</p><hr />
          <h2 id="gcon_25" style={titleStyle}>~くれる - Ge (pil in) <a href="#gcon_25">#</a></h2>
          ...
          <p>Textbok kap. 14</p><hr />
          <h2 id="gcon_24" style={titleStyle}>~あげる - Ge (pil ut) <a href="#gcon_24">#</a></h2>
          ...
          <h2 id="gcon_35" style={titleStyle}>~てくれる - Ge tjänst (pil in) <a href="#gcon_35">#</a></h2>
          ...
          <p>Textbok kap. 16</p><hr />
          <h2 id="gcon_36" style={titleStyle}>~てもらう - Få tjänst <a href="#gcon_36">#</a></h2>
          ...
          <p>Textbok kap. 16</p><hr />
          <h2 id="gcon_27" style={titleStyle}>~たらどうですか - Min rekommendation <a href="#gcon_27">#</a></h2>
          ...
          <p>Textbok kap. 14</p><hr />
          <h2 id="gcon_28" style={titleStyle}>~をX台も - Så många som... <a href="#gcon_28">#</a></h2>
          ...
          <p>Textbok kap. 14</p><hr />
          <h2 id="gcon_29" style={titleStyle}>~をX台しか - Inte mer än... <a href="#gcon_29">#</a></h2>
          ...
          <p>Textbok kap. 15</p><hr />
          <h2 id="gcon_33" style={titleStyle}>- - Att kvalificera substantiv med bisatser <a href="#gcon_33">#</a></h2>
          ...
          <p>Textbok kap. 16</p><hr />
          <h2 id="gcon_41" style={titleStyle}>~といいんですが - Jag hoppas själv... <a href="#gcon_41">#</a></h2>
          ...
          <p>Textbok kap. 16</p><hr />
          <h2 id="gcon_1" style={titleStyle}>~そうです - Jag hörde att... <a href="#gcon_1">#</a></h2>
          ...
          <h2 id="gcon_2" style={titleStyle}>~って - Jag hörde att... <a href="#gcon_2">#</a></h2>
          <p>って kan användas istället för そうです i informella sammanhang.</p>
          <p>Textbok kap. 17</p><hr />
          <h2 id="gcon_3" style={titleStyle}>~たら - Om och när <a href="#gcon_3">#</a></h2>
          ...
          <hr />
          <p>Textbok kap. 17</p><hr />
          <h2 id="gcon_4" style={titleStyle}>~なくてもいいです - Du behöver inte... <a href="#gcon_4">#</a></h2>
          ...
          <DisplayQuestion primaryText={'そんなに緊張しなくてもいいですよ。'} secondaryText={'There\'s no need to be that tense.'} japaneseCharacters showSpeechButton smallerText /><br />
          <DisplayQuestion primaryText={'入院しなくてもいいです。'} secondaryText={'You don\'t have to stay in the hospital.'} japaneseCharacters showSpeechButton smallerText /><br />
          <DisplayQuestion primaryText={'焦らなくてもいいですよ。'} secondaryText={'You don\'t have to hurry.'} japaneseCharacters showSpeechButton smallerText /><br />
          <DisplayQuestion primaryText={'わざわざ家に来なくてもいいですよ。'} secondaryText={'Do not bother to come to my home.'} japaneseCharacters showSpeechButton smallerText /><br />
          <DisplayQuestion primaryText={'あなたは昼食代を払わなくてもいいですよ。'} secondaryText={'You don\'t need to pay for your lunch.'} japaneseCharacters showSpeechButton smallerText /><br />
          <DisplayQuestion primaryText={'資金のことについて心配しなくてもいいですよ。'} secondaryText={'There is no need to worry about funds.'} japaneseCharacters showSpeechButton smallerText /><br />
          <DisplayQuestion primaryText={'昼ごはんを持ってこなくてもいいです。'} secondaryText={'You do not have to bring your lunch.'} japaneseCharacters showSpeechButton smallerText /><br />
          <DisplayQuestion primaryText={'トムさんは車を洗わなくてもいいです。メアリーさんはもう洗いましたから。'} secondaryText={'Tom doesn\'t have to wash the car. Mary\'s already washed it.'} japaneseCharacters showSpeechButton smallerText /><br />
          <DisplayQuestion primaryText={'明日は来なくてもいいですよ。'} secondaryText={'You don\'t have to come tomorrow.'} japaneseCharacters showSpeechButton smallerText /><br />
          <DisplayQuestion primaryText={'言い訳しなくてもいいですよ。'} secondaryText={'You don\'t have to make excuses.'} japaneseCharacters showSpeechButton smallerText /><br />
          ><hr />
          <p>Textbok kap. 17</p><hr />
          <h2 id="gcon_5" style={titleStyle}>~みたいです - Liknar... Är som... (substantiv) <a href="#gcon_5">#</a></h2>
          ...
          <DisplayQuestion primaryText={'彼はまるで君の弟みたいだよ。 '} secondaryText={'He looks like your brother.'} japaneseCharacters showSpeechButton smallerText /><br />
          <DisplayQuestion primaryText={'警官みたいですね。 '} secondaryText={'You look like a policeman.'} japaneseCharacters showSpeechButton smallerText /><br />
          <hr />
          <p>Textbok kap. 17</p><hr />
          <h2 id="gcon_6" style={titleStyle}>~みたいです - Verkar... Ser ut som att... (verb) <a href="#gcon_6">#</a></h2>
          ...
          <DisplayQuestion primaryText={'彼女はアメリカ人ではないみたいです。'} secondaryText={'She doesn\'t seem to be an American.'} japaneseCharacters showSpeechButton smallerText /><br />
          ...
          <h2 id="gcon_10" style={titleStyle}>~てしまう - Göra klart, fullfölja <a href="#gcon_10">#</a></h2>
          ...
          <p>Textbok kap. 18</p><hr />
          <h2 id="gcon_11" style={titleStyle}>~てしまう - Oavsiktligt <a href="#gcon_11">#</a></h2>
          ...
          <p>Textbok kap. 18</p><hr />
          <h2 id="gcon_13" style={titleStyle}>~ながら - Samtidigt utförande <a href="#gcon_13">#</a></h2>
          ...
          <p>Textbok kap. 18</p><hr />
          <h2 id="gcon_14" style={titleStyle}>~ばよかったです - Jag borde ha... Jag önskar att jag hade... <a href="#gcon_14">#</a></h2>
...
grammarScreen.defaultProps = Utility.reduxEnabledDefaultProps({

}, Reducers);

grammarScreen.propTypes = Utility.reduxEnabledPropTypes({
