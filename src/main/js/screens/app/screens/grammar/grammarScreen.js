      ...
      <Col xs={12} md={8} mdOffset={2}>
        <div>
          ...
          <p>
            ...
            böjs verbet som ett ru-verb. Partiklar bibehålls, men を kan bli antingen を eller が. För できる ersätts を
            oftast med が.
          </p>
          <DisplayQuestion
          ...
          <p>
            ...
            anledning X し、 anledning Y し、 situation Z。. Situationen kan komma först, situation Z。 anledning X し、
            anledning Y し。. Anledningarna är på kortform. Om bara ett し används så implicerar det fler, outtalade,
            anledningar.
          </p>
          <DisplayQuestion
          ...
          <p>
            Verb på て-form + みる indikerar att man ska försöka eller titta på att göra verbhandlingen. "Jag ska se om
            det går att laga cykeln." Observera att hjälpverbet みる alltid skrivs med kana, trots att det egentligen är
            samma som 見る.
          </p>
          <p>Textbok kap. 13</p>
          <hr />
          ...
          <p>
            ...
            motorcykel? Bara bil, inte motorcykel." "Gillade du kinesiska? Japanska, kinesiska har jag aldrig studerat."
          </p>
          <p>Textbok kap. 13</p>
          <hr />
          ...
          <p>
            ほしい är ett adjektiv som talar om att objektet är åtråvärt för mig, och är det vanliga sättet att tala om
            att man vill ha något. Dvs "Jag vill ha mat" formuleras som "Mat är åtråvärt för mig".
          </p>
          <p>Textbok kap. 14</p>
          <hr />
          ...
          <p>
            Gåvor som gynnar mig direkt eller indirekt (grov generalisering) kräver くれる istället för あげる. Om någon
            ger mig något, så är det jag som gynnas, och då används くれる. Om en främling ger min bror något, så
            används också också くれる, man kan tänka att om min familj blir rikare så smittar det av sig på mig, men
            min ena bror ger något till min andra bror så är det status quo, och då ska inte くれる användas. Det är
            inte släktskap i sig som spelar roll, utan emotionell närhet, mina bästa vänner kan ingå i min inre sfär, t
            ex. En person man pratar med just nu brukar också ingå i en inre sfär. Om man tänker sig gåvans väg, så rör
            den sig in mot mig. Jämför med あげる.
          </p>
          <p>Textbok kap. 14</p>
          <hr />
          ...
          <p>
            En grov tumregel är att om inte jag blir berikad, direkt eller indirekt, så används あげる. Exemple på detta
            är om jag ger något, om en främling ger något till en annan främling, om en familjemdlem ger en annan
            familjemedlem något. Om man tänker sig gåvans väg, så rör den sig ut från mig, eller åtminstone inte in mot
            mig. Jämför med くれる.
          </p>
          <p>Textbok kap. 14</p>
          <hr />
          ...
          <p>
            Verb på kortform dåtid + らどうですか, är ett råd eller rekommendation. Det kan uppfattas som uppläxande, så
            använd med viss försiktighet. "Du borde motionera lite oftare." Observera att man inte kan använda uttrycket
            för att bjuda hem någon.
          </p>
          <p>Textbok kap. 14</p>
          <hr />
          ...
          <p>
            Man lägger på も efter räknaren för att tala om att talet är ett stort antal i sammanhanget. Dvs substantiv
            + をX台も + uttryck, där X台 är ett tal inklusive räknare. Det kan förstås vara en annan räknare än 台.
          </p>
          <p>Textbok kap. 14</p>
          <hr />
          ...
          <p>
            Volitionalformen tillsammans med と思っています indikerar intention. Man har bestämt sig för att göra något.
            Med と思います indikerarat det också intention, men något man bestämt här och nu.
          </p>
          <p>Textbok kap. 15</p>
          <hr />
          ...
          <p>
            Verb på て-form + いただけませんか används för en artig förfrågan, vilket vara lämpligt gentemot en främling
            eller överordnad.
          </p>
          <p>Textbok kap. 16</p>
          <hr />
          ...
          <p>
            Verb på て-form + くれませんか kan användas i normalformella sammanhang för en förfrågan. Ungefär samma nivå
            som ください.
          </p>
          <p>Textbok kap. 16</p>
          <hr />
          ...
          <p>
            Verb på kortform, icke-dåtid + といいですね uttrycker en positiv önskan för någon annan. "Hoppas du får bra
            väder på din resa". Används inte för mottagarens egna handlingar. Vardaglig form är といいね. Jfr med
            といいんですが.
          </p>
          <p>Textbok kap. 16</p>
          <hr />
          ...
          <p>
            Verb på kortform, icke-dåtid + といいんですが uttrycker en positiv önskan för egen del. "Hoppas jag får bra
            väder på resan". Används inte för egna handlingar, dvs sådan som ligger under min egen kontroll, t ex kan
            man inte använda det till "Jag hoppas kunna resa till Japan snart". Vardaglig form är といいんだけど. Jfr
            med といいですね.
          </p>
          <p>Textbok kap. 16</p>
          <hr />
          ...
          <p>
            ...
            att...". Man vet var informationen kommer ifrån, t ex person, tidning, TV, och vill man ange källan kan man
            inleda meningen med "[källa]によると...そうです", enligt [källa]... Uttrycket böjs normalt sett inte, men
            man kan använda そうだ i informella sammanhang.
          </p>
          <p>Textbok kap. 17</p>
          <hr />
          ...
          <p>
            Ett たら-uttryck bildas av ett villkor på kortform dåtid + ら, där kortformen är jakande eller nekande, och
            följs av konsekvens. "Om jag hinner, så kommer jag." Sannolikheten för villkoret kan variera, tara kan
          ...
          <p>
            ...
            transitiva par. Tyvärr följer de inget bestämt mönster, även om det finns subgrupper med mönster. Det är med
            andra ord bara att lära sig varje par för sig.
          </p>
          <p>Textbok kap. 18</p>
          <hr />
          ...
          <p>
            Verb på te-form + しまう indikerar att något görs klart, eller fullföljs. "Jag har ätit upp." "Jag har läst
            ut boken." Obs! Se "Oavsiktligt" för alternativ tolkning!
          </p>
          <p>Textbok kap. 18</p>
          <hr />
          ...
          <p>
            ...
            specifika händelser, "När jag körde för fort blev jag stoppad av polisen." När Y innehåller en adjektivfras
            används ofta なる, "楽しくなる", "元気になる".
          </p>
          <p>Textbok kap. 18</p>
          <hr />
          ...
          <p>
            {' '}
            Verb på kortform, jakande, icke-dåtid, - u + ばよかったです eller Verb på kortform, nekande, icke-dåtid, - i
            + ばよかったです. Det betyder "Jag borde ha...", eller "Jag önskar att jag hade...".
          </p>
          <p>Textbok kap. 18</p>
          <hr />
          <p>
