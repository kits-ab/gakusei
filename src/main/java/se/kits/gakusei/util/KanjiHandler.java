...
public class KanjiHandler {
    ...
    public List<Kanji> chooseKanjis(List<Kanji> kanjis, int quantity) {
        List<Kanji> visibleKanjis = kanjis.stream().filter(kanji -> !kanji.isHidden()).collect(Collectors.toList());
    ...
    public List<HashMap<String, Object>> createKanjiQuestions(List<Kanji> chosenKanjis) {
