...
//        basePackages = {"se.kits.gakusei.content.repository"}
//)
//public class ContentConfig {
//
//    @Bean(name = "contentDataSource")
//    @ConfigurationProperties(prefix = "gakuseicontent.datasource")
...
//        return builder.dataSource(contentDataSource)
//                .packages("se.kits.gakusei.content.model")
