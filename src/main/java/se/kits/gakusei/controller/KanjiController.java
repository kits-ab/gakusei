...
public class KanjiController {
    ...
    @Autowired
    public KanjiController(LessonRepository lessonRepository, KanjiHandler kanjiHandler) {
    ...
    ResponseEntity<List<HashMap<String, Object>>> getKanjiQuestionsFromLesson(
        ...
        List<HashMap<String, Object>> questions = getCachedKanjiQuestionsFromLesson(lessonName, username);
    ...
    private List<HashMap<String, Object>> getCachedKanjiQuestionsFromLesson(String lessonName, String username) {
        List<Kanji> allLessonKanjis = cachedFindKanjis(lessonName);
        List<Kanji> chosenKanjis = kanjiHandler.chooseKanjis(allLessonKanjis, quantity);
